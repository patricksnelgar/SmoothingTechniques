...
public class SmoothingTechniques extends AbstractClassifier implements Regressor {
	...
	protected int filterTweet(List<String> tweet) {
		...
		if (tweet.size() < SmoothingTechniques.MinNumberOfWords)
			return -1;
